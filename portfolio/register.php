...
<head>
    ...
    <title>Registrarse - Gametica</title>
    <style>
        body {
            ...
            <div class="col-6 form-container">
                ...
                <form id="registerForm" method="POST">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="registroNombre" name="nombre" required maxlength="30">
                    </div>
                    <div class="mb-3">
                        <label for="registroEmail" class="form-label">Email</label>
                        <input type="email" class="form-control" id="registroEmail" name="email" required maxlength="50">
                    </div>
                    <div class="mb-3">
                        <label for="registroPassword" class="form-label">Contraseña</label>
                        <input type="password" class="form-control" id="registroPassword" name="password" required maxlength="15">
                    </div>
